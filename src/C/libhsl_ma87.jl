...
function ma87_default_control_s(control)
  @ccall libhsl_ma87.ma87_default_control_s(control::Ref{ma87_control{Float32}})::Cvoid
end
...
function ma87_analyse_s(n, ptr, row, order, keep, control, info)
  @ccall libhsl_ma87.ma87_analyse_s(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint}, order::Ptr{Cint},
...
function ma87_factor_s(n, ptr, row, val, order, keep, control, info)
  @ccall libhsl_ma87.ma87_factor_s(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma87_factor_solve_s(n, ptr, row, val, order, keep, control, info, nrhs, ldx, x)
  @ccall libhsl_ma87.ma87_factor_solve_s(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{Float32}, order::Ptr{Cint},
                                         keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float32}},
...
function ma87_solve_s(job, nrhs, ldx, x, order, keep, control, info)
  @ccall libhsl_ma87.ma87_solve_s(job::Cint, nrhs::Cint, ldx::Cint, x::Ptr{Float32},
...
function ma87_sparse_fwd_solve_s(nbi, bindex, b, order, invp, nxi, index, x, w, keep, control, info)
  @ccall libhsl_ma87.ma87_sparse_fwd_solve_s(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{Float32},
...
function ma87_finalise_s(keep, control)
  @ccall libhsl_ma87.ma87_finalise_s(keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float32}})::Cvoid
end

function ma87_default_control_d(control)
  @ccall libhsl_ma87.ma87_default_control_d(control::Ref{ma87_control{Float64}})::Cvoid
end

function ma87_analyse_d(n, ptr, row, order, keep, control, info)
  @ccall libhsl_ma87.ma87_analyse_d(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint}, order::Ptr{Cint},
...
function ma87_factor_d(n, ptr, row, val, order, keep, control, info)
  @ccall libhsl_ma87.ma87_factor_d(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma87_factor_solve_d(n, ptr, row, val, order, keep, control, info, nrhs, ldx, x)
  @ccall libhsl_ma87.ma87_factor_solve_d(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{Float64}, order::Ptr{Cint},
                                         keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float64}},
...
function ma87_solve_d(job, nrhs, ldx, x, order, keep, control, info)
  @ccall libhsl_ma87.ma87_solve_d(job::Cint, nrhs::Cint, ldx::Cint, x::Ptr{Float64},
                                  order::Ptr{Cint}, keep::Ptr{Ptr{Cvoid}},
...
function ma87_sparse_fwd_solve_d(nbi, bindex, b, order, invp, nxi, index, x, w, keep, control, info)
  @ccall libhsl_ma87.ma87_sparse_fwd_solve_d(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{Float64},
                                             order::Ptr{Cint}, invp::Ptr{Cint}, nxi::Ptr{Cint},
...
function ma87_finalise_d(keep, control)
  @ccall libhsl_ma87.ma87_finalise_d(keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float64}})::Cvoid
end

function ma87_default_control_c(control)
  @ccall libhsl_ma87.ma87_default_control_c(control::Ref{ma87_control{Float32}})::Cvoid
end

function ma87_analyse_c(n, ptr, row, order, keep, control, info)
  @ccall libhsl_ma87.ma87_analyse_c(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint}, order::Ptr{Cint},
                                    keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float32}},
                                    info::Ref{ma87_info{Float32}})::Cvoid
end

function ma87_factor_c(n, ptr, row, val, order, keep, control, info)
  @ccall libhsl_ma87.ma87_factor_c(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma87_factor_solve_c(n, ptr, row, val, order, keep, control, info, nrhs, ldx, x)
  @ccall libhsl_ma87.ma87_factor_solve_c(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{ComplexF32}, order::Ptr{Cint},
                                         keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float32}},
                                         info::Ref{ma87_info{Float32}}, nrhs::Cint, ldx::Cint,
...
function ma87_solve_c(job, nrhs, ldx, x, order, keep, control, info)
  @ccall libhsl_ma87.ma87_solve_c(job::Cint, nrhs::Cint, ldx::Cint, x::Ptr{ComplexF32},
                                  order::Ptr{Cint}, keep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma87_control{Float32}}, info::Ref{ma87_info{Float32}})::Cvoid
end

function ma87_sparse_fwd_solve_c(nbi, bindex, b, order, invp, nxi, index, x, w, keep, control, info)
  @ccall libhsl_ma87.ma87_sparse_fwd_solve_c(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{ComplexF32},
                                             order::Ptr{Cint}, invp::Ptr{Cint}, nxi::Ptr{Cint},
...
function ma87_finalise_c(keep, control)
  @ccall libhsl_ma87.ma87_finalise_c(keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float32}})::Cvoid
end

function ma87_default_control_z(control)
  @ccall libhsl_ma87.ma87_default_control_z(control::Ref{ma87_control{Float64}})::Cvoid
end

function ma87_analyse_z(n, ptr, row, order, keep, control, info)
  @ccall libhsl_ma87.ma87_analyse_z(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint}, order::Ptr{Cint},
                                    keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float64}},
                                    info::Ref{ma87_info{Float64}})::Cvoid
end

function ma87_factor_z(n, ptr, row, val, order, keep, control, info)
  @ccall libhsl_ma87.ma87_factor_z(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma87_factor_solve_z(n, ptr, row, val, order, keep, control, info, nrhs, ldx, x)
  @ccall libhsl_ma87.ma87_factor_solve_z(n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{ComplexF64}, order::Ptr{Cint},
                                         keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float64}},
                                         info::Ref{ma87_info{Float64}}, nrhs::Cint, ldx::Cint,
...
function ma87_solve_z(job, nrhs, ldx, x, order, keep, control, info)
  @ccall libhsl_ma87.ma87_solve_z(job::Cint, nrhs::Cint, ldx::Cint, x::Ptr{ComplexF64},
                                  order::Ptr{Cint}, keep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma87_control{Float64}}, info::Ref{ma87_info{Float64}})::Cvoid
end

function ma87_sparse_fwd_solve_z(nbi, bindex, b, order, invp, nxi, index, x, w, keep, control, info)
  @ccall libhsl_ma87.ma87_sparse_fwd_solve_z(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{ComplexF64},
                                             order::Ptr{Cint}, invp::Ptr{Cint}, nxi::Ptr{Cint},
...
function ma87_finalise_z(keep, control)
  @ccall libhsl_ma87.ma87_finalise_z(keep::Ptr{Ptr{Cvoid}}, control::Ref{ma87_control{Float64}})::Cvoid
end
