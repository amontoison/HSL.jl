function ma48_initialize_s(factors)
  @ccall libhsl_ma48.ma48_initialize_s(factors::Ptr{Ptr{Cvoid}})::Cvoid
end
...
function ma48_default_control_s(control)
  @ccall libhsl_ma48.ma48_default_control_s(control::Ref{ma48_control{Float32}})::Cvoid
end
...
function ma48_analyse_s(m, n, ne, row, col, val, factors, control, ainfo, finfo, perm, endcol)
  @ccall libhsl_ma48.ma48_analyse_s(m::Cint, n::Cint, ne::Clong, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma48_factorize_s(m, n, ne, row, col, val, factors, control, finfo, fast, partial)
  @ccall libhsl_ma48.ma48_factorize_s(m::Cint, n::Cint, ne::Clong, row::Ptr{Cint}, col::Ptr{Cint},
                                      val::Ptr{Float32}, factors::Ptr{Cvoid},
                                      control::Ref{ma48_control{Float32}}, finfo::Ref{ma48_finfo{Float32}},
                                      fast::Cint, partial::Cint)::Cvoid
end
...
function ma48_solve_s(m, n, ne, row, col, val, factors, rhs, x, control, sinfo, trans, resid, error)
  @ccall libhsl_ma48.ma48_solve_s(m::Cint, n::Cint, ne::Clong, row::Ptr{Cint}, col::Ptr{Cint},
                                  val::Ptr{Float32}, factors::Ptr{Cvoid},
...
function ma48_finalize_s(factors, control)
  @ccall libhsl_ma48.ma48_finalize_s(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma48_control{Float32}})::Cint
end

function ma48_special_rows_and_cols_s(factors, rank, rows, cols, control)
  @ccall libhsl_ma48.ma48_special_rows_and_cols_s(factors::Ptr{Cvoid}, rank::Ptr{Cint},
...
function ma48_determinant_s(factors, sgndet, logdet, control)
  @ccall libhsl_ma48.ma48_determinant_s(factors::Ptr{Cvoid}, sgndet::Ptr{Cint},
                                        logdet::Ptr{Float32},
                                        control::Ref{ma48_control{Float32}})::Cint
end

function ma48_initialize_d(factors)
  @ccall libhsl_ma48.ma48_initialize_d(factors::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma48_default_control_d(control)
  @ccall libhsl_ma48.ma48_default_control_d(control::Ref{ma48_control{Float64}})::Cvoid
end

function ma48_analyse_d(m, n, ne, row, col, val, factors, control, ainfo, finfo, perm, endcol)
  @ccall libhsl_ma48.ma48_analyse_d(m::Cint, n::Cint, ne::Clong, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma48_factorize_d(m, n, ne, row, col, val, factors, control, finfo, fast, partial)
  @ccall libhsl_ma48.ma48_factorize_d(m::Cint, n::Cint, ne::Clong, row::Ptr{Cint}, col::Ptr{Cint},
                                      val::Ptr{Float64}, factors::Ptr{Cvoid},
                                      control::Ref{ma48_control{Float64}}, finfo::Ref{ma48_finfo{Float64}},
                                      fast::Cint, partial::Cint)::Cvoid
end

function ma48_solve_d(m, n, ne, row, col, val, factors, rhs, x, control, sinfo, trans, resid, error)
  @ccall libhsl_ma48.ma48_solve_d(m::Cint, n::Cint, ne::Clong, row::Ptr{Cint}, col::Ptr{Cint},
                                  val::Ptr{Float64}, factors::Ptr{Cvoid},
...
function ma48_finalize_d(factors, control)
  @ccall libhsl_ma48.ma48_finalize_d(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma48_control{Float64}})::Cint
end

function ma48_special_rows_and_cols_d(factors, rank, rows, cols, control)
  @ccall libhsl_ma48.ma48_special_rows_and_cols_d(factors::Ptr{Cvoid}, rank::Ptr{Cint},
                                                  rows::Ptr{Cint}, cols::Ptr{Cint},
                                                  control::Ref{ma48_control{Float64}})::Cint
end

function ma48_determinant_d(factors, sgndet, logdet, control)
  @ccall libhsl_ma48.ma48_determinant_d(factors::Ptr{Cvoid}, sgndet::Ptr{Cint},
                                        logdet::Ptr{Float64},
                                        control::Ref{ma48_control{Float64}})::Cint
end
