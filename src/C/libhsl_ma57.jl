...
function ma57_default_control_s(control)
  @ccall libhsl_ma57.ma57_default_control_s(control::Ref{ma57_control{Float32}})::Cvoid
end

function ma57_init_factors_s(factors)
  @ccall libhsl_ma57.ma57_init_factors_s(factors::Ptr{Ptr{Cvoid}})::Cvoid
end
...
function ma57_analyse_s(n, ne, row, col, factors, control, ainfo, perm)
  @ccall libhsl_ma57.ma57_analyse_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma57_factorize_s(n, ne, row, col, val, factors, control, finfo)
  @ccall libhsl_ma57.ma57_factorize_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma57_solve_s(n, ne, row, col, val, factors, nrhs, x, control, sinfo, rhs, iter, cond)
  @ccall libhsl_ma57.ma57_solve_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma57_finalize_s(factors, control, info)
  @ccall libhsl_ma57.ma57_finalize_s(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float32}},
                                     info::Ptr{Cint})::Cvoid
end

function ma57_enquire_perm_s(control, factors, perm)
  @ccall libhsl_ma57.ma57_enquire_perm_s(control::Ref{ma57_control{Float32}}, factors::Ptr{Ptr{Cvoid}},
                                         perm::Ptr{Cint})::Cvoid
end

function ma57_enquire_pivots_s(control, factors, pivots)
  @ccall libhsl_ma57.ma57_enquire_pivots_s(control::Ref{ma57_control{Float32}}, factors::Ptr{Ptr{Cvoid}},
                                           pivots::Ptr{Cint})::Cvoid
end

function ma57_enquire_d_s(factors, d)
  @ccall libhsl_ma57.ma57_enquire_d_s(factors::Ptr{Ptr{Cvoid}}, d::Ptr{Float32})::Cvoid
end

function ma57_enquire_perturbation_s(factors, perturbation)
  @ccall libhsl_ma57.ma57_enquire_perturbation_s(factors::Ptr{Ptr{Cvoid}},
                                                 perturbation::Ptr{Float32})::Cvoid
end

function ma57_enquire_scaling_s(factors, scaling)
  @ccall libhsl_ma57.ma57_enquire_scaling_s(factors::Ptr{Ptr{Cvoid}},
                                            scaling::Ptr{Float32})::Cvoid
end

function ma57_alter_d_s(factors, d, info)
  @ccall libhsl_ma57.ma57_alter_d_s(factors::Ptr{Ptr{Cvoid}}, d::Ptr{Float32},
                                    info::Ptr{Cint})::Cvoid
end

function ma57_part_solve_s(factors, control, part, nrhs, x, info)
  @ccall libhsl_ma57.ma57_part_solve_s(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float32}},
                                       part::Cchar, nrhs::Cint, x::Ptr{Float32},
                                       info::Ptr{Cint})::Cvoid
end

function ma57_sparse_lsolve_s(factors, control, nzrhs, irhs, nzsoln, isoln, x, sinfo)
  @ccall libhsl_ma57.ma57_sparse_lsolve_s(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float32}},
...
function ma57_fredholm_alternative_s(factors, control, x, fredx, sinfo)
  @ccall libhsl_ma57.ma57_fredholm_alternative_s(factors::Ptr{Ptr{Cvoid}},
...
function ma57_lmultiply_s(factors, control, trans, x, y, sinfo)
  @ccall libhsl_ma57.ma57_lmultiply_s(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float32}},
...
function ma57_get_factors_s(factors, control, nzl, iptrl, lrows, lvals, nzd, iptrd, drows, dvals,
  ...
  @ccall libhsl_ma57.ma57_get_factors_s(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float32}},
...
function ma57_default_control_d(control)
  @ccall libhsl_ma57.ma57_default_control_d(control::Ref{ma57_control{Float64}})::Cvoid
end

function ma57_init_factors_d(factors)
  @ccall libhsl_ma57.ma57_init_factors_d(factors::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma57_analyse_d(n, ne, row, col, factors, control, ainfo, perm)
  @ccall libhsl_ma57.ma57_analyse_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma57_factorize_d(n, ne, row, col, val, factors, control, finfo)
  @ccall libhsl_ma57.ma57_factorize_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma57_solve_d(n, ne, row, col, val, factors, nrhs, x, control, sinfo, rhs, iter, cond)
  @ccall libhsl_ma57.ma57_solve_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
...
function ma57_finalize_d(factors, control, info)
  @ccall libhsl_ma57.ma57_finalize_d(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float64}},
                                     info::Ptr{Cint})::Cvoid
end

function ma57_enquire_perm_d(control, factors, perm)
  @ccall libhsl_ma57.ma57_enquire_perm_d(control::Ref{ma57_control{Float64}}, factors::Ptr{Ptr{Cvoid}},
                                         perm::Ptr{Cint})::Cvoid
end

function ma57_enquire_pivots_d(control, factors, pivots)
  @ccall libhsl_ma57.ma57_enquire_pivots_d(control::Ref{ma57_control{Float64}}, factors::Ptr{Ptr{Cvoid}},
                                           pivots::Ptr{Cint})::Cvoid
end

function ma57_enquire_d_d(factors, d)
  @ccall libhsl_ma57.ma57_enquire_d_d(factors::Ptr{Ptr{Cvoid}}, d::Ptr{Float64})::Cvoid
end

function ma57_enquire_perturbation_d(factors, perturbation)
  @ccall libhsl_ma57.ma57_enquire_perturbation_d(factors::Ptr{Ptr{Cvoid}},
                                                 perturbation::Ptr{Float64})::Cvoid
end

function ma57_enquire_scaling_d(factors, scaling)
  @ccall libhsl_ma57.ma57_enquire_scaling_d(factors::Ptr{Ptr{Cvoid}},
                                            scaling::Ptr{Float64})::Cvoid
end

function ma57_alter_d_d(factors, d, info)
  @ccall libhsl_ma57.ma57_alter_d_d(factors::Ptr{Ptr{Cvoid}}, d::Ptr{Float64},
                                    info::Ptr{Cint})::Cvoid
end

function ma57_part_solve_d(factors, control, part, nrhs, x, info)
  @ccall libhsl_ma57.ma57_part_solve_d(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float64}},
                                       part::Cchar, nrhs::Cint, x::Ptr{Float64},
                                       info::Ptr{Cint})::Cvoid
end

function ma57_sparse_lsolve_d(factors, control, nzrhs, irhs, nzsoln, isoln, x, sinfo)
  @ccall libhsl_ma57.ma57_sparse_lsolve_d(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float64}},
                                          nzrhs::Cint, irhs::Ptr{Cint}, nzsoln::Ptr{Cint},
...
function ma57_fredholm_alternative_d(factors, control, x, fredx, sinfo)
  @ccall libhsl_ma57.ma57_fredholm_alternative_d(factors::Ptr{Ptr{Cvoid}},
...
function ma57_lmultiply_d(factors, control, trans, x, y, sinfo)
  @ccall libhsl_ma57.ma57_lmultiply_d(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float64}},
...
function ma57_get_factors_d(factors, control, nzl, iptrl, lrows, lvals, nzd, iptrd, drows, dvals,
                            perm, invperm, scale, sinfo)
  @ccall libhsl_ma57.ma57_get_factors_d(factors::Ptr{Ptr{Cvoid}}, control::Ref{ma57_control{Float64}},
                                        nzl::Ptr{Cint}, iptrl::Ptr{Cint}, lrows::Ptr{Cint},
