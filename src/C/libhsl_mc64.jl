...
function mc64_default_control_s(control)
  @ccall libhsl_mc64.mc64_default_control_s(control::Ref{mc64_control})::Cvoid
end
...
function mc64_matching_s(job, matrix_type, m, n, ptr, row, cval, control, info, perm, scale)
  @ccall libhsl_mc64.mc64_matching_s(job::Cint, matrix_type::Cint, m::Cint, n::Cint, ptr::Ptr{Cint},
...
function mc64_default_control_d(control)
  @ccall libhsl_mc64.mc64_default_control_d(control::Ref{mc64_control})::Cvoid
end

function mc64_matching_d(job, matrix_type, m, n, ptr, row, cval, control, info, perm, scale)
  @ccall libhsl_mc64.mc64_matching_d(job::Cint, matrix_type::Cint, m::Cint, n::Cint, ptr::Ptr{Cint},
...
function mc64_default_control_c(control)
  @ccall libhsl_mc64.mc64_default_control_c(control::Ref{mc64_control})::Cvoid
end

function mc64_matching_c(job, matrix_type, m, n, ptr, row, cval, control, info, perm, scale)
  @ccall libhsl_mc64.mc64_matching_c(job::Cint, matrix_type::Cint, m::Cint, n::Cint, ptr::Ptr{Cint},
...
function mc64_default_control_z(control)
  @ccall libhsl_mc64.mc64_default_control_z(control::Ref{mc64_control})::Cvoid
end

function mc64_matching_z(job, matrix_type, m, n, ptr, row, cval, control, info, perm, scale)
  @ccall libhsl_mc64.mc64_matching_z(job::Cint, matrix_type::Cint, m::Cint, n::Cint, ptr::Ptr{Cint},
