...
function ma97_default_control_s(control)
  @ccall libhsl_ma97.ma97_default_control_s(control::Ref{ma97_control{Float32}})::Cvoid
end
...
function ma97_analyse_s(check, n, ptr, row, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_s(check::Cint, n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma97_analyse_coord_s(n, ne, row, col, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_coord_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                          val::Ptr{Float32}, akeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}},
                                          order::Ptr{Cint})::Cvoid
end
...
function ma97_factor_s(matrix_type, ptr, row, val, akeep, fkeep, control, info, scale)
  @ccall libhsl_ma97.ma97_factor_s(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                   val::Ptr{Float32}, akeep::Ptr{Ptr{Cvoid}},
...
function ma97_factor_solve_s(matrix_type, ptr, row, val, nrhs, x, ldx, akeep, fkeep, control, info,
                             scale)
  @ccall libhsl_ma97.ma97_factor_solve_s(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{Float32}, nrhs::Cint,
                                         x::Ptr{Float32}, ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                         fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                         info::Ref{ma97_info{Float32}}, scale::Ptr{Float32})::Cvoid
end

function ma97_solve_s(job, nrhs, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_s(job::Cint, nrhs::Cint, x::Ptr{Float32}, ldx::Cint,
...
function ma97_free_akeep_s(akeep)
  @ccall libhsl_ma97.ma97_free_akeep_s(akeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_free_fkeep_s(fkeep)
  @ccall libhsl_ma97.ma97_free_fkeep_s(fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_finalise_s(akeep, fkeep)
  @ccall libhsl_ma97.ma97_finalise_s(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_enquire_posdef_s(akeep, fkeep, control, info, d)
  @ccall libhsl_ma97.ma97_enquire_posdef_s(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                           control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}},
                                           d::Ptr{Float32})::Cvoid
end

function ma97_enquire_indef_s(akeep, fkeep, control, info, piv_order, d)
  @ccall libhsl_ma97.ma97_enquire_indef_s(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}},
                                          piv_order::Ptr{Cint}, d::Ptr{Float32})::Cvoid
end

function ma97_alter_s(d, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_alter_s(d::Ptr{Float32}, akeep::Ptr{Ptr{Cvoid}},
                                  fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                  info::Ref{ma97_info{Float32}})::Cvoid
end

function ma97_solve_fredholm_s(nrhs, flag_out, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_fredholm_s(nrhs::Cint, flag_out::Ptr{Cint}, x::Ptr{Float32},
                                           ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                           fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                           info::Ref{ma97_info{Float32}})::Cvoid
end

function ma97_lmultiply_s(trans, k, x, ldx, y, ldy, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_lmultiply_s(trans::Cint, k::Cint, x::Ptr{Float32}, ldx::Cint,
...
function ma97_sparse_fwd_solve_s(nbi, bindex, b, order, nxi, xindex, x, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_sparse_fwd_solve_s(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{Float32},
...
function ma97_default_control_d(control)
  @ccall libhsl_ma97.ma97_default_control_d(control::Ref{ma97_control{Float64}})::Cvoid
end

function ma97_analyse_d(check, n, ptr, row, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_d(check::Cint, n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma97_analyse_coord_d(n, ne, row, col, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_coord_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                          val::Ptr{Float64}, akeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}},
                                          order::Ptr{Cint})::Cvoid
end
...
function ma97_factor_d(matrix_type, ptr, row, val, akeep, fkeep, control, info, scale)
  @ccall libhsl_ma97.ma97_factor_d(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                   val::Ptr{Float64}, akeep::Ptr{Ptr{Cvoid}},
...
function ma97_factor_solve_d(matrix_type, ptr, row, val, nrhs, x, ldx, akeep, fkeep, control, info,
                             scale)
  @ccall libhsl_ma97.ma97_factor_solve_d(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{Float64}, nrhs::Cint,
                                         x::Ptr{Float64}, ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                         fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                         info::Ref{ma97_info{Float64}}, scale::Ptr{Float64})::Cvoid
end

function ma97_solve_d(job, nrhs, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_d(job::Cint, nrhs::Cint, x::Ptr{Float64}, ldx::Cint,
                                  akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}})::Cvoid
end

function ma97_free_akeep_d(akeep)
  @ccall libhsl_ma97.ma97_free_akeep_d(akeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_free_fkeep_d(fkeep)
  @ccall libhsl_ma97.ma97_free_fkeep_d(fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_finalise_d(akeep, fkeep)
  @ccall libhsl_ma97.ma97_finalise_d(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_enquire_posdef_d(akeep, fkeep, control, info, d)
  @ccall libhsl_ma97.ma97_enquire_posdef_d(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                           control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}},
                                           d::Ptr{Float64})::Cvoid
end

function ma97_enquire_indef_d(akeep, fkeep, control, info, piv_order, d)
  @ccall libhsl_ma97.ma97_enquire_indef_d(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}},
                                          piv_order::Ptr{Cint}, d::Ptr{Float64})::Cvoid
end

function ma97_alter_d(d, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_alter_d(d::Ptr{Float64}, akeep::Ptr{Ptr{Cvoid}},
                                  fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                  info::Ref{ma97_info{Float64}})::Cvoid
end

function ma97_solve_fredholm_d(nrhs, flag_out, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_fredholm_d(nrhs::Cint, flag_out::Ptr{Cint}, x::Ptr{Float64},
                                           ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                           fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                           info::Ref{ma97_info{Float64}})::Cvoid
end
...
function ma97_lmultiply_d(trans, k, x, ldx, y, ldy, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_lmultiply_d(trans::Cint, k::Cint, x::Ptr{Float64}, ldx::Cint,
...
function ma97_sparse_fwd_solve_d(nbi, bindex, b, order, nxi, xindex, x, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_sparse_fwd_solve_d(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{Float64},
                                             order::Ptr{Cint}, nxi::Ptr{Cint}, xindex::Ptr{Cint},
...
function ma97_default_control_c(control)
  @ccall libhsl_ma97.ma97_default_control_c(control::Ref{ma97_control{Float32}})::Cvoid
end

function ma97_analyse_c(check, n, ptr, row, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_c(check::Cint, n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma97_analyse_coord_c(n, ne, row, col, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_coord_c(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                          val::Ptr{ComplexF32}, akeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}},
                                          order::Ptr{Cint})::Cvoid
end
...
function ma97_factor_c(matrix_type, ptr, row, val, akeep, fkeep, control, info, scale)
  @ccall libhsl_ma97.ma97_factor_c(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                   val::Ptr{ComplexF32}, akeep::Ptr{Ptr{Cvoid}},
                                   fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                   info::Ref{ma97_info{Float32}}, scale::Ptr{Float32})::Cvoid
end
...
function ma97_factor_solve_c(matrix_type, ptr, row, val, nrhs, x, ldx, akeep, fkeep, control, info,
                             scale)
  @ccall libhsl_ma97.ma97_factor_solve_c(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{ComplexF32}, nrhs::Cint,
                                         x::Ptr{ComplexF32}, ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                         fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                         info::Ref{ma97_info{Float32}}, scale::Ptr{Float32})::Cvoid
end

function ma97_solve_c(job, nrhs, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_c(job::Cint, nrhs::Cint, x::Ptr{ComplexF32}, ldx::Cint,
                                  akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}})::Cvoid
end

function ma97_free_akeep_c(akeep)
  @ccall libhsl_ma97.ma97_free_akeep_c(akeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_free_fkeep_c(fkeep)
  @ccall libhsl_ma97.ma97_free_fkeep_c(fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_finalise_c(akeep, fkeep)
  @ccall libhsl_ma97.ma97_finalise_c(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_enquire_posdef_c(akeep, fkeep, control, info, d)
  @ccall libhsl_ma97.ma97_enquire_posdef_c(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                           control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}},
                                           d::Ptr{Float32})::Cvoid
end

function ma97_enquire_indef_c(akeep, fkeep, control, info, piv_order, d)
  @ccall libhsl_ma97.ma97_enquire_indef_c(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float32}}, info::Ref{ma97_info{Float32}},
                                          piv_order::Ptr{Cint}, d::Ptr{ComplexF32})::Cvoid
end

function ma97_alter_c(d, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_alter_c(d::Ptr{ComplexF32}, akeep::Ptr{Ptr{Cvoid}},
                                  fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                  info::Ref{ma97_info{Float32}})::Cvoid
end

function ma97_solve_fredholm_c(nrhs, flag_out, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_fredholm_c(nrhs::Cint, flag_out::Ptr{Cint}, x::Ptr{ComplexF32},
                                           ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                           fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float32}},
                                           info::Ref{ma97_info{Float32}})::Cvoid
end
...
function ma97_lmultiply_c(trans, k, x, ldx, y, ldy, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_lmultiply_c(trans::Cint, k::Cint, x::Ptr{ComplexF32}, ldx::Cint,
...
function ma97_sparse_fwd_solve_c(nbi, bindex, b, order, nxi, xindex, x, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_sparse_fwd_solve_c(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{ComplexF32},
                                             order::Ptr{Cint}, nxi::Ptr{Cint}, xindex::Ptr{Cint},
...
function ma97_default_control_z(control)
  @ccall libhsl_ma97.ma97_default_control_z(control::Ref{ma97_control{Float64}})::Cvoid
end

function ma97_analyse_z(check, n, ptr, row, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_z(check::Cint, n::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
...
function ma97_analyse_coord_z(n, ne, row, col, val, akeep, control, info, order)
  @ccall libhsl_ma97.ma97_analyse_coord_z(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                          val::Ptr{ComplexF64}, akeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}},
                                          order::Ptr{Cint})::Cvoid
end
...
function ma97_factor_z(matrix_type, ptr, row, val, akeep, fkeep, control, info, scale)
  @ccall libhsl_ma97.ma97_factor_z(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                   val::Ptr{ComplexF64}, akeep::Ptr{Ptr{Cvoid}},
                                   fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                   info::Ref{ma97_info{Float64}}, scale::Ptr{Float64})::Cvoid
end
...
function ma97_factor_solve_z(matrix_type, ptr, row, val, nrhs, x, ldx, akeep, fkeep, control, info,
                             scale)
  @ccall libhsl_ma97.ma97_factor_solve_z(matrix_type::Cint, ptr::Ptr{Cint}, row::Ptr{Cint},
                                         val::Ptr{ComplexF64}, nrhs::Cint,
                                         x::Ptr{ComplexF64}, ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                         fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                         info::Ref{ma97_info{Float64}}, scale::Ptr{Float64})::Cvoid
end

function ma97_solve_z(job, nrhs, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_z(job::Cint, nrhs::Cint, x::Ptr{ComplexF64}, ldx::Cint,
                                  akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}})::Cvoid
end

function ma97_free_akeep_z(akeep)
  @ccall libhsl_ma97.ma97_free_akeep_z(akeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_free_fkeep_z(fkeep)
  @ccall libhsl_ma97.ma97_free_fkeep_z(fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_finalise_z(akeep, fkeep)
  @ccall libhsl_ma97.ma97_finalise_z(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}})::Cvoid
end

function ma97_enquire_posdef_z(akeep, fkeep, control, info, d)
  @ccall libhsl_ma97.ma97_enquire_posdef_z(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                           control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}},
                                           d::Ptr{Float64})::Cvoid
end

function ma97_enquire_indef_z(akeep, fkeep, control, info, piv_order, d)
  @ccall libhsl_ma97.ma97_enquire_indef_z(akeep::Ptr{Ptr{Cvoid}}, fkeep::Ptr{Ptr{Cvoid}},
                                          control::Ref{ma97_control{Float64}}, info::Ref{ma97_info{Float64}},
                                          piv_order::Ptr{Cint}, d::Ptr{ComplexF64})::Cvoid
end

function ma97_alter_z(d, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_alter_z(d::Ptr{ComplexF64}, akeep::Ptr{Ptr{Cvoid}},
                                  fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                  info::Ref{ma97_info{Float64}})::Cvoid
end

function ma97_solve_fredholm_z(nrhs, flag_out, x, ldx, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_solve_fredholm_z(nrhs::Cint, flag_out::Ptr{Cint}, x::Ptr{ComplexF64},
                                           ldx::Cint, akeep::Ptr{Ptr{Cvoid}},
                                           fkeep::Ptr{Ptr{Cvoid}}, control::Ref{ma97_control{Float64}},
                                           info::Ref{ma97_info{Float64}})::Cvoid
end
...
function ma97_lmultiply_z(trans, k, x, ldx, y, ldy, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_lmultiply_z(trans::Cint, k::Cint, x::Ptr{ComplexF64}, ldx::Cint,
...
function ma97_sparse_fwd_solve_z(nbi, bindex, b, order, nxi, xindex, x, akeep, fkeep, control, info)
  @ccall libhsl_ma97.ma97_sparse_fwd_solve_z(nbi::Cint, bindex::Ptr{Cint}, b::Ptr{ComplexF64},
                                             order::Ptr{Cint}, nxi::Ptr{Cint}, xindex::Ptr{Cint},
